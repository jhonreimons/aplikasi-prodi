                    ...
                    <div class="row">
                         <div class="content">
                              <div class="card-header">
                                   <strong class="card-title">Data KPU HIMATEK</strong>
                              </div>
                              <div class="form-group">
                                   <label id="nama_divisi" for="nama_divisi" class="control-label mb-1">Kepala Divisi</label>
                              ...
                              <div class="form-group">
                                   <label for="Jumlah Mahasiswa" class="control-label mb-1">Sekretaris</label>
