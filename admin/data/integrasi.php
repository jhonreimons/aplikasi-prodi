...
<head>
     ...
     <title>Integrasi Kegiatan Penelitan/PkM dalam Pembelajaran</title>
                         ...
                         <div class="content">
                              <div class="card">
                                   <div class="card-header">
                                        <strong class="card-title">Integrasi Kegiatan Penelitan/PkM dalam Pembelajaran</strong>
                                   </div>
                                   <div class="card-body">
                                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                             <thead>
                                                  <tr>
                                                       <th rowspan="2">Judul Penelitian dan PkM</th> 
