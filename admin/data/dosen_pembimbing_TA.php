...
<head>
     ...
     <title>Dosen Pembimbing Utama Tugas Akhir</title>
                         ...
                         <div class="content">
                              <div class="card">
                                   <div class="card-header">
                                        <strong class="card-title">Dosen Pembimbing Utama Tugas Akhir</strong>
                                   </div>
                                   <div class="card-body">
                                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                             <thead>
                                                  <tr>
                                                       ...
                                                       <th rowspan="2">Rata-rata Jumlah Bimbingan/Tahun</th> 
                                                       <th rowspan="2">Rata-rata Jumlah Bimbingan diseluruh Program/Tahun</th> </tr>
                                                       </tr>
                                                       <tr>
                                                       <th>pada PS yang Diakreditasi</th>
                                                       <th>pada PS lain pada Program sama di PT</th>
