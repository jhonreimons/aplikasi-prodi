...
<head>
     ...
     <title>Penelitian DTPS yang Menjadi Rujukan Tema Tesis/Disertasi</title>
                         ...
                         <div class="content">
                              <div class="card">
                                   <div class="card-header">
                                        <strong class="card-title">Penelitian DTPS yang Menjadi Rujukan Tema Tesis/Disertasi</strong>
                                   </div>
                                   <div class="card-body">
                                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                             <thead>
                                                  <tr>
                                                       ...
                                                       <th rowspan="2">Judul Tesis/Disertasi</th> 
