                    ...
                    <div class="row">
                         <div class="content">
                              <div class="card-header">
                                   <strong class="card-title">Buat Data Dosen</strong>
                              </div>
                              <div class="card-body">
                                   <form action="" method="post" novalidate="novalidate">
                                        <div class="form-group">
                                             <label for="nama_dosen" class="control-label mb-1">Nama Dosen</label>
                                             <input id="nama_dosen" name="nama_dosen" type="text" class="form-control" aria-required="true" placeholder="Nama Lengkap beserta gelar" aria-invalid="false">
                                        </div>
                                        <div class="form-group">
                                             <label for="nidn" class="control-label mb-1">NIDN</label>
                                             <input id="nidn" name="nidn" type="text" class="form-control" aria-required="true" aria-invalid="false" PLACEholder="Contoh: 0108098301">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                             ...
                                             <input id="pascasarjana" name="pascasarjana" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Jurusan Pascasarjana">
                                        </div>
                                        <div class="form-group">
                                             <label for="universitas" class="control-label mb-1">Universitas</label>
                                             <input id="universitas" name="universitas" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Universitas">
                                        </div>
                                        <div class="form-group">
                                             <label for="bidang_keahlian" class="control-label mb-1">Bidang Keahlian</label>
                                             <input id="bidang_keahlian" name="bidang_keahlian" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Bidang Keahlian">
                                        </div>
                                        <div>
