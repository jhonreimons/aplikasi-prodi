                    ...
                    <div class="row">
                         <div class="content">
                              <div class="card-header">
                                   <strong class="card-title">Data Divisi HIMATEK</strong>
                              </div>
                              <div class="form-group">
                                   <label id="nama_divisi" for="nama_divisi" class="control-label mb-1">Divisi</label>
                                   <select name="nama_divisi" id="nama_divisi" class="form-control">
                                        <option value="#">Pilih Divisi Himpunan</option>
                                        <?php
                                        $sql =  mysqli_query($conn, "SELECT * FROM divisi");
                                        while ($row = mysqli_fetch_assoc($sql)) :
                                        ?>
                                             <option value="<?php echo $row['id_divisi']; ?>">
                                             <?php echo $row['nama_divisi']; ?></option>
                                        <?php endwhile; ?>
                                   </select>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                   <label for="tahun_ajaran" class="control-label mb-1">Anggota</label>
