                         ...
                         <div class="content">
                              ...
                              <div class="table-stats order-table ov-h">
                                   <table class="table " style="color: red;">
                                        <thead>
                                             <tr>
                                                  <th class="serial text-center">1.Menyelenggarakan pengajaran yang mencetak dan membina Sumber Daya Manusia yang mampu bekerja pada industri teknik komputer yang mempunyai sikap pemimpin, penuh kreativitas, berdisiplin tinggi, dan mampu memberikan solusi di bidang teknik komputer dan membuat terobosan dalam dunia pendidikan dengan menciptakan lingkungan pendidikan yang sehat dengan dukungan tenaga pengajar yang ahli dan profesional.
                                             <tr>
                                                  <th class="serial text-center">2.Menyelenggarakan program penelitian yang menghasilkan produk unggul tepat guna untuk penerapan teknik komputer di berbagai bidang kehidupan masyarakat.
                                             <tr>
                                                  <th class="serial text-center">3.Menyelenggarakan pengabdian kepada masyarakat di bidang Teknik Komputer melalui berbagai program diseminasi teknologi terhadap masyarakat di berbagai bidang.
                                             <tr>
                                                  <th class="serial text-center">4.Menciptakan lingkungan civitas akademika dan unit pendukung yang kondusif.
                                             </tr>
                                        </thead>
                                        <tbody>
                                             <?php $i = 1;
