                    ...
                    <div class="row">
                         <div class="content">
                              <div class="card-header">
                                   <strong class="card-title">Ubah Data Publikasi</strong>
                              </div>
                              <div class="card-body">
                                   <form action="" method="post" novalidate="novalidate">
                                        ...
                                        <?php
                                        $id = $_GET['id-publikasi'];
                                             $sql = "SELECT * FROM m_publikasi WHERE id_dosen = '$id'";
                                             $query = mysqli_query($connection,$sql);
                                             $data = mysqli_fetch_assoc($query);
                                        ?>
                                        <div class="form-group">
                                             <label id="judul_publikasi" for="judul_publikasi" class="control-label mb-1">Judul Publikasi</label>
                                             <input id="judul_publikasi" value="<?php echo $data['judul_publikasi']; ?>" name="judul_publikasi" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                             <input id="judul_publikasi" value="<?php echo $data['id_publikasi']; ?>" name="id" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                        </div>
                                        <div class="form-group">
                                             <label id="tahun_akademik" for="tahun_akademik" class="control-label mb-1">Tahun Akademik</label>
                                             <input id="tahun_akademik" value="<?php echo $data['id_tahun_akademik']; ?>" name="tahun_akademik" type="number" class="form-control" aria-required="true" aria-invalid="false">
                                        </div>
                                        <div>
