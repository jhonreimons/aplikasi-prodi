...
<head>
     ...
     <title>Ubah data tugas akhir</title>
                    ...
                    <div class="row">
                         <div class="content">
                              ...
                              <div class="card-body">
                                   ...
                                   <?php 
                                   $id = $_GET['id-ta'];
                                   $query = "SELECT * FROM data_ta WHERE id_data_ta = '$id'"; 
                                        $sql =  mysqli_query($connection,$query);
                                        $data = mysqli_fetch_assoc($sql);
                                   ?>
                                   <div class="form-group">
                                        <label for="Jumlah Mahasiswa" class="control-label mb-1">Jumlah Mahasiswa</label>
                                        <input id="Jumlah Mahasiswa" value="<?php echo $data['jumlah_yg_dibimbing'];?>" name="jumlah_mahasiswa" type="number" class="form-control" aria-required="true" aria-invalid="false">
                                   </div>
                                   <div class="form-group">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input id="id" value="<?php echo $data['id_data_ta'];?>" name="id" type="hidden">
                                        <input id="Jumlah Mahasiswa" value="<?= $data['judul']; ?>" name="judul_tugas_akhir" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                   </div>
                                   <div class="form-group">
