...
if (isset($_POST['submit'])) {
     ...
     $query = "INSERT INTO data_ta(id_data_ta,id_dosen_pembimbing,kelompok,judul,id_dosen_penguji_1,id_dosen_penguji_2, tahun_ajaran)
                    ...
                    <div class="row">
                         <div class="content">
                              <div class="card-header">
                                   <strong class="card-title">Data Pengurusan HIMATEK</strong>
                              </div>
                              <div class="card-body">
                                   <div class="form-group">
                                        <form action="" method="post" class="pt-3">
                                             <label id="dosen_pembimbing" for="dosen_pembimbing" class="control-label mb-1">Ketua</label>
                                             <input id="Jumlah Mahasiswa" name="jumlah_mahasiswa" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                   </div>

                                   <div class="form-group">
                                        <label for="Jumlah Mahasiswa" class="control-label mb-1">Wakil Ketua</label>
                                        <input id="Jumlah Mahasiswa" name="jumlah_mahasiswa" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                   </div>
                                   <div class="form-group">
                                        <label for="tahun_ajaran" class="control-label mb-1">Sekretaris</label>
                                        <input id="tahun_ajaran" name="tahun_ajaran" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                   </div>
                                   <div class="form-group">
                                        <label for="judul_tugas_akhir" class="control-label mb-1">Bendahara</label>
